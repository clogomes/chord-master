...
BACKING_TRACK_LIBRARY: Dict[str, RhythmPattern] = {
    ...
    "pop": RhythmPattern(id="pop", name_pt="Pop (4/4)", time_signature="4/4", steps_per_bar=16, grid=[["kick", "hihat_closed"], [], ["hihat_closed"], [], ["snare", "hihat_closed"], [], ["hihat_closed"], [], ["kick", "hihat_closed"], ["kick"], ["hihat_closed"], [], ["snare", "hihat_closed"], [], ["hihat_closed"], ["kick", "hihat_open"]]),
