...
TECHNIQUE_EXERCISES: List[TechniqueExercise] = [
    ...
    TechniqueExercise(
        ...
        description_pt="Padrão clássico de Hanon para independência dos dedos 4 e 5 na mão direita e esquerda.",
        description_en="Classic Hanon pattern for 4th and 5th finger independence across both hands.",
        notes=[
            ...
            Note("C5"), Note("G4"), Note("F4"), Note("E4"), Note("D4"), Note("E4"), Note("F4"), Note("G4"),
            Note("C4"),
        ],
    ...
    TechniqueExercise(
        ...
        name_pt="Movimento Contrário das Mãos",
        name_en="Contrary Motion Scale Drill",
        category="forca_agilidade",
        instrument="piano",
        difficulty="Avançado",
        description_pt="Desenvolve coordenação motora bilateral com as mãos a moverem-se em direções opostas.",
        description_en="Builds bilateral brain and hand coordination by expanding outward from C4.",
        notes=[
    ...
    TechniqueExercise(
        ...
        instrument="guitar",
        difficulty="Iniciante",
        description_pt="O exercício de aquecimento clássico para violão/guitarra. Desenvolve independência dos 4 dedos da mão esquerda.",
        description_en="The quintessential guitar warmup drill. Builds left-hand finger independence across strings.",
        notes=[
            Note("E2"), Note("F2"), Note("F#2"), Note("G2"),
            Note("A2"), Note("A#2"), Note("B2"), Note("C3"),
        ],
        recommended_bpm_range=(60, 110),
    ),
    TechniqueExercise(
        ...
        notes=[
            Note("E2"), Note("E4"), Note("A2"), Note("B3"), Note("D3"), Note("G3"), Note("G3"), Note("E4"),
        ],
    ...
    TechniqueExercise(
        ...
        instrument="guitar",
        difficulty="Avançado",
        description_pt="Desenvolve flexibilidade muscular e abertura da mão esquerda para acordes em pestana e solos estendidos.",
        description_en="Develops left-hand muscular flexibility and finger span for wide chord reaches.",
        notes=[
            Note("F2"), Note("G2"), Note("A2"), Note("C3"), Note("D3"), Note("E3"), Note("G3"), Note("A3"), Note("B3"),
        ],
