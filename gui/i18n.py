...
UI_STRINGS: Dict[str, Dict[str, str]] = {
    "pt": {
        ...
        "nav_practice_technique": "⚡ Exercícios Técnicos",
        ...
        "nav_practice_rhythm": "🥁 Prática Rítmica",
        "rhythm_exercise_label": "Padrão:",
        "rhythm_hint": "Pré-para-te: quando a contagem terminar, bate no tempo certo.",
        "rhythm_countin": "Contagem de entrada...",
        "rhythm_tap_now": "Bate no tempo certo! (Espaço)",
        "rhythm_tap": "👏 BATIR (Espaço)",
        "rhythm_acc": "Precisão média",
        "rhythm_on_time": "batidas certas",
        "rhythm_avg_abs": "Desvio médio absoluto",
        "rhythm_avg_signed": "Desvio médio",
        "rhythm_late": "Estás a bater sistematicamente ATRASADO — tenta antecipares um pouco.",
        "rhythm_early": "Estás a bater sistematicamente ADIANTADO — tenta segurares mais.",
        "rhythm_steady": "Bom equilíbrio: sem tendência clara para atrasar ou adiantar.",
        "nav_glossary": "📚 Glossário Musical",
        "nav_daily_review": "🔄 Revisão de Hoje",
    ...
    "en": {
        ...
        "nav_practice_technique": "⚡ Technical Drills",
        ...
        "nav_practice_rhythm": "🥁 Rhythm Practice",
        "rhythm_exercise_label": "Pattern:",
        "rhythm_hint": "Get ready: when the count-in ends, tap on the beat.",
        "rhythm_countin": "Counting in...",
        "rhythm_tap_now": "Tap on the beat! (Space)",
        "rhythm_tap": "👏 TAP (Space)",
        "rhythm_acc": "Average accuracy",
        "rhythm_on_time": "on-time taps",
        "rhythm_avg_abs": "Average absolute offset",
        "rhythm_avg_signed": "Average offset",
        "rhythm_late": "You're tapping systematically LATE — try to anticipate a little.",
        "rhythm_early": "You're tapping systematically EARLY — try to hold back.",
        "rhythm_steady": "Good balance: no clear tendency to run late or early.",
        "nav_glossary": "📚 Musical Glossary",
        "nav_daily_review": "🔄 Today's Review",
